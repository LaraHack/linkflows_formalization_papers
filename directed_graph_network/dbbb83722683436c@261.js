...
md`# Ordered Force-Directed Graph(Network graph)`
)});
  main.variable(observer()).define(["md"], function(md){return(
md`-- SET UP --`
)});
...
d3.scaleOrdinal() //=d3.scaleOrdinal(d3.schemeSet2)
  ...
  main.variable(observer("myChart")).define("myChart", ["html","d3","width","margin","height","colorScale"], function(html,d3,width,margin,height,colorScale)
{
